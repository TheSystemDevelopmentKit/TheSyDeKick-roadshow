...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\sectiontitle[Example 1: Inverter]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\sectiontitle[Example 2: Inverter chain]
...
\begin{frame}[t]
    ...
    \begin{figure}
        \begin{center}
            \subfloat[Interpolator SW]{\includegraphics[width=0.4\textwidth]{./Pics/interp_out_f_sw.eps}}\qquad
            \subfloat[Interpolator
            HW]{\includegraphics[width=0.4\textwidth]{./Pics/interp_out_f_hw.eps}}
        \end{center}
    \end{figure}
...
\begin{frame}[t]
    ...
    \begin{figure}
        \begin{center}
            ...
            16-bit)]{\includegraphics[width=0.30\textwidth]{Pics/evm_16bit.eps}}\qquad
            \subfloat[Interpolator HW (EVM,
            20-bit)]{\includegraphics[width=0.4\textwidth]{Pics/evm_20bit.eps}}
        \end{center}
     \end{figure}
     \begin{itemize}
...
\begin{frame}[t]
    ...
    \end{center}
    \begin{figure}
        \subfloat[Interpolator (HW, EVM)]{\includegraphics[width=0.4\textwidth]{Pics/evm_interp_v4.eps}}\qquad
        \subfloat[Interpolator (HW,
        ACLR)]{\includegraphics[width=0.4\textwidth]{Pics/interp_hw_ACLR_v4.eps}}
    \end{figure}
    \begin{itemize}
        \item EVM : $0.338\%$
...
\begin{frame}[t]
    ...
    \begin{figure}
        \begin{center}
            \subfloat[Interpolator (HW, EVM)]{\includegraphics[width=0.4\textwidth]{./Pics/evm_interp_v4wmem.eps}}\qquad
            \subfloat[Interpolator (HW, ACLR)]{\includegraphics[width=0.4\textwidth]{./Pics/interp_hw_ACLR_v4wmem.eps}}
        \end{center}
    \end{figure}
    \begin{itemize}
        \item EVM : $0.339\%$
...
\begin{frame}[t]
    ...
    \end{center}
    \begin{figure}
        \subfloat[EVM, SCS RTL simulation)]{\includegraphics[height=4cm,width=5cm]{./Pics/evm_6bit_scswmem.eps}}\qquad
        \subfloat[ACLR, SCS RTL simulation)]{\includegraphics[height=4cm,width=5cm]{./Pics/scswmem_res6_ACLR.eps}}
    \end{figure}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{figure}
        \begin{center}
            \subfloat[EVM SCS RTL simulation]{\includegraphics[width=0.4\textwidth]{./Pics/evm_10bit_scs_v6wmem.eps}}\qquad
            \subfloat[ACLR SCS RTL simulation]{\includegraphics[width=0.4\textwidth]{./Pics/scs_10b_ACLR_v6wmem.eps}}
        \end{center}
    \end{figure}
    \begin{itemize}
        \item EVM: $0.336\%$
